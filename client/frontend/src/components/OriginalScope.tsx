...
const OriginalScope: React.FC<OriginalScopeProps> = ({ partnerId }) => {
  ...
  const getRequiredMissingFunctionalities = () => {
    ...
    return scopeData.functionalities.filter(func => {
      ...
      // Check if any integration pattern has this functionality as "General Availability"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h2 className="text-lg font-semibold text-blue-900">Klarna Acquiring Partner Integration Availability</h2>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {scopeData.matrix.map((row) => (
                <tr key={row.functionality.id} className="hover:bg-gray-50">
                  ...
                  {INTEGRATION_PATTERNS.map(pattern => {
                    // Find the scope item for this functionality and integration pattern
                    const partnerKey = Object.keys(row.partners)[0]; // Get first partner key
